...
/**
 * Classe de serviço responsável por mockar os dados dos domínios no profile de
 * testes
 * 
...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "adrianorteste@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "adrianorrocha26@gmail.com", "31628382740",
				TipoCliente.PESSOAFISICA, bCryptPasswordEncoder.encode("123"));
		...
		repoProduto.saveAll(Arrays.asList(p12, p13, p14, p15, p16, p17, p18, p19, p20,
